...
import { ECDMovementGame } from "./ECDMovementGame";
import { LevelMap } from "./LevelMap";
import { QuizScreen } from "./QuizScreen";

export function LearningHub() {
	const [activeTab, setActiveTab] = useState<
		"quizzes" | "simulators" | "challenges"
	>("quizzes");
	const [currentView, setCurrentView] = useState<"hub" | "quiz" | "game">(
		"hub",
	);
	...
	if (currentView === "game") {
		return <ECDMovementGame onBack={handleBack} />;
	}
					...
					{activeTab === "quizzes" && (
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							>
								...
								<p className="text-[#7D8B91] mb-4">
									Test your knowledge about saving and spending
								</p>
							...
							<div className="bg-white rounded-[20px] p-6 shadow-[0_4px_16px_rgba(0,0,0,0.08)]">
								...
								<p className="text-[#7D8B91] mb-4">
									Learn the basics of growing your money
								</p>
								<div className="flex items-center justify-between">
					...
					{activeTab === "simulators" && (
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							>
								...
								<p className="text-[#7D8B91] mb-4">
									Predict market movements and earn points
								</p>
								<div className="flex items-center justify-between">
							...
							<div className="bg-white rounded-[20px] p-6 shadow-[0_4px_16px_rgba(0,0,0,0.08)]">
								...
								<p className="text-[#7D8B91] mb-4">
									Practice creating a monthly budget
								</p>
								<div className="flex items-center justify-between">
									<span className="text-[#2EC4B6]">Interactive</span>
									<span className="text-[#7D8B91]">Level 2</span>
					...
					{activeTab === "challenges" && (
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							<div className="bg-white rounded-[20px] p-6 shadow-[0_4px_16px_rgba(0,0,0,0.08)]">
								...
								<p className="text-[#7D8B91] mb-4">
									Save a little bit every day for a month
								</p>
								<div className="flex items-center justify-between">
									<span className="text-[#FFD447]" style={{ color: "#D4A016" }}>
										Challenge
									</span>
							...
							<div className="bg-white rounded-[20px] p-6 shadow-[0_4px_16px_rgba(0,0,0,0.08)]">
								...
								<p className="text-[#7D8B91] mb-4">
									Make wise spending choices for a week
								</p>
								<div className="flex items-center justify-between">
									<span className="text-[#FFD447]" style={{ color: "#D4A016" }}>
										Challenge
