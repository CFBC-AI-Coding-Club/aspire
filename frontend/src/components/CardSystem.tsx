  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div className="space-y-3">
        <div>
          <p className="text-[#1B262C]">Standard Card</p>
          <p className="text-[#7D8B91]">White background, Shadow 0 4 16 8%, Radius 20px, Padding 16</p>
        </div>
      ...
      <div className="space-y-3">
        <div>
          <p className="text-[#1B262C]">Metric Card</p>
          <p className="text-[#7D8B91]">Gradient Light Blue, Bold number top, Icon top-right, Radius 20px</p>
        </div>
      ...
      <div className="space-y-3">
        <div>
          <p className="text-[#1B262C]">Game Card</p>
          <p className="text-[#7D8B91]">Bright background, Rounded 24px, Fun icon</p>
        </div>
